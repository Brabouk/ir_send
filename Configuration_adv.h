 ...
 */
#define E0_AUTO_FAN_PIN P1_26 // FAN1_PIN defaults to Extruder2 heater pin, safe to use with only 1 heater   //X_MAX_PIN  - P1_28 can be used if triggering an external driver (such as mostfet or relay)
#define E1_AUTO_FAN_PIN E0_AUTO_FAN_PIN // Y_MAX_PIN - P1_26 //E0_AUTO_FAN_PIN 
 ...
 */
  ...
  #define MIN_PROBE_EDGE_LEFT MIN_PROBE_EDGE    // X 0 
  #define MIN_PROBE_EDGE_RIGHT MIN_PROBE_EDGE    // X Max side
  #define MIN_PROBE_EDGE_FRONT BedClampDistanceFromEdge   //Going to Y 0
  #define MIN_PROBE_EDGE_BACK BedClampDistanceFromEdge    //Going towards Y MAX
#endif
...
#define MAX_CMD_SIZE 96   // Max size of the command to receive over serial
#define BUFSIZE 64        // Number of lines to have in the serial buffer     // Original = 4 -> Bumped to 64 since primarily using OctoPrint
 ...
 */
  ...
  // ORIGINAL Current values were 800, but that was with Chopper_Timing CHOPPER_DEFAULT_12V. 24v requires half the current for same power level.
  #if AXIS_IS_TMC(X)
  ...
  #define Y2_HYBRID_THRESHOLD    Y2_HYBRID_THRESHOLD
