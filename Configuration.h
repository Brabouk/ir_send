...
#define SHOW_BOOTSCREEN //Boot Screen Disabled for memory saving
...
#define CUSTOM_MACHINE_NAME "SKR_1.3"
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 402, 97.38 }
 ...
 *
 */
//#define Z_MIN_PROBE_PIN 24  //Z_MAX_PIN is defined by SKR_1.3 Pins -- BLTouch Moved to Z_Min Pin so Z_MAX_PIN can be used to trigger 'Controller_Fan'
 ...
 */
#define NOZZLE_TO_PROBE_OFFSET { -41.4, -14, -1.3 }
...
#define Z_PROBE_SPEED_SLOW ( 1 * 60 )   // (Z_PROBE_SPEED_FAST / 4) 
...
#define EXTRA_PROBING    1  //If Enabled, will add 1 extra probe to the count. So total probes = MultipleProbe+ExtraProbing
...
#define Z_CLEARANCE_MULTI_PROBE     2 // Z Clearance between multiple probes      //2.5mm is where BLTouch probe just barely touches bed when deployed.
...
#define LEVEL_BED_CORNERS
  ...
  #define LEVEL_CORNERS_INSET_LFRB { 5, 15, 5, 15 } // (mm) Left, Front, Right, Back insets
